...
const Ecommerce = () => {
  ...
  const [product, setprouduct] = useState(
    "HUAWEI MateBook X Pro U7-155H 32GB +1TB Morandi Blue Windows 11 Pro",
  );
  ...
  const handleFirstClick = (titleP, priceP, photoP) => {
    ...
    setTimeout(() => {
      if (!secondClickedDuringSleep.current) {
        ...
        saveProduct(
          productToSave.current.sku,
          productToSave.current.title,
          productToSave.current.price,
          productToSave.current.photo,
        );
      ...
      <div className="flex-1">
        <div className="max-w-[1200px] mx-auto px-5 mt-8">
          ...
          <div className="grid [grid-template-columns:repeat(auto-fit,minmax(260px,1fr))] gap-5 md:mb-10">
            {/* iMac */}
            <div
              className="flex flex-col border border-slate-200 rounded-2xl bg-white overflow-hidden shadow-[0_2px_10px_rgba(0,0,0,0.06)] transition-transform duration-200 hover:-translate-y-[3px] hover:shadow-lg"
              onClick={incrementClicks}
            >
              <div className="h-56 w-full flex items-center justify-center bg-white">
                <a href="#" className="block">
                  <img
                    id="imacPhoto"
                    className="mx-auto h-full max-h-52 object-contain"
              ...
              <div className="pt-6 px-6 pb-6 flex-grow flex flex-col justify-between">
                ...
                <div className="mt-4 flex items-center justify-between gap-4">
                  <p
                    id="imacPrice"
                    className="text-2xl font-extrabold leading-tight text-slate-900"
                  >
                    $1699,00
                  </p>
                  <div className="flex flex-col space-y-3">
                    <button
                      ...
                      onClick={() =>
                        handleFirstClick("imacTitle", "imacPrice", "imacPhoto")
                      }
                    >
                      <svg
                ...
                <div className="mt-4 flex items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col space-y-3">
                    ...
                    <button
                      type="button"
                      className="inline-flex items-center bg-rose-500 hover:bg-rose-600 text-white font-semibold py-2 px-4 rounded-lg focus:outline-none focus:ring-4 focus:ring-rose-300 active:shadow-inner transition"
                      onClick={() => RemoveItem("matebookTitle")}
                    >
                      ✕ Rimuovi
                    </button>
                  </div>
              ...
              <div className="pt-6 px-6 pb-6 flex-grow flex flex-col justify-between">
                <div>
                  <a
                    ...
                    className="text-lg font-semibold leading-tight text-slate-900 line-clamp-2"
                  >
                    Apple Watch Series 9 GPS 41mm Smartwatch con cassa in
                    alluminio color mezzanotte e Cinturino Sport mezzanotte
                  </a>
                  <div className="mt-2 flex items-center gap-2">
                    <div className="flex items-center text-amber-400">
                      {[...Array(5)].map((_, i) => (
              ...
              <div className="pt-6 px-6 pb-6 flex-grow flex flex-col justify-between">
                <div>
                  <a
                    ...
                    className="text-lg font-semibold leading-tight text-slate-900 line-clamp-2"
                  >
                    Apple iPad Pro 11'': Chip M4 Progettato per Apple
                    Intelligence, display Ultra Retina XDR, 256GB
                  </a>
                  <div className="mt-2 flex items-center gap-2">
                    <div className="flex items-center text-amber-400">
                      {[...Array(5)].map((_, i) => (
                ...
                <div className="mt-4 flex items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col space-y-3">
                    <button
                      ...
                      className="inline-flex items-center bg-sky-500 hover:bg-sky-600 text-white font-semibold py-2 px-4 rounded-lg focus:outline-none focus:ring-4 focus:ring-sky-300 active:shadow-inner transition"
                      onClick={() =>
                        handleFirstClick("ipadTitle", "ipadPrice", "ipadPhoto")
                      }
                    >
                      <svg
                        className="-ms-2 me-2 h-5 w-5"
                ...
                <div className="mt-4 flex items-center justify-between gap-4">
                  ...
                  <div className="flex flex-col space-y-3">
                    <button
                      ...
                      className="inline-flex items-center bg-sky-500 hover:bg-sky-600 text-white font-semibold py-2 px-4 rounded-lg focus:outline-none focus:ring-4 focus:ring-sky-300 active:shadow-inner transition"
                      onClick={() =>
                        handleFirstClick("ps5Title", "ps5Price", "ps5Photo")
                      }
                    >
                      <svg
                        className="-ms-2 me-2 h-5 w-5"
            ...
            <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
              <div className="bg-white p-6 rounded-2xl shadow-2xl w-full max-w-md text-center">
                ...
                <p className="mb-6 text-slate-700">
                  Hai trovato tutti i bug! Puoi passare al prossimo gruppo di
                  test!
                </p>
                <button
                  onClick={closeModal}
